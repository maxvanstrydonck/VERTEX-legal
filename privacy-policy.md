...
authentication provider; we never see it), display name, and chosen username.
...
account**. This permanently deletes your account, profile, workouts, follows, kudos,
and blocks from our servers and removes the local copy from your device. Reports you
filed about other users are retained (without your account link) for moderation
history.

## Notifications

Workout reminders are scheduled locally on your device. No push tokens or
notification data are sent to our servers.

## Children

VERTEX is not directed at children under 13, and we do not knowingly collect data
from them.
